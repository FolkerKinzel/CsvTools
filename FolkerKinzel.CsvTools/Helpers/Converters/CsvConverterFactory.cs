    ...
    public static class CsvConverterFactory
    {
        ...
        public static ICsvTypeConverter CreateConverter(
            ...
            bool throwOnParseErrors = false) => type switch
            {
                ...
                CsvTypeCode.Date => new DateTimeConverter("d", nullable, maybeDBNull, provider, throwOnParseErrors),
                CsvTypeCode.DateTime => new DateTimeConverter("s", nullable, maybeDBNull, provider, throwOnParseErrors),
